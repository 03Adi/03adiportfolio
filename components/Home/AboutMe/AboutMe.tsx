...
export default function AboutMe(props) {
  const technologies = [
    [
      ...
      <span className="text-AAsecondary">PHP</span>,
      <span className="text-AAsecondary">Shopify</span>,
      <span className="text-AAsecondary">Nextjs/React</span>,
      <span className="text-AAsecondary">TypeScript/JavaScript</span>,
      <span className="text-AAsecondary">Tailwind CSS</span>,
    ],
    [
      <span className="text-AAsecondary">MySQL</span>,
      <span className="text-AAsecondary">MongoDB</span>,
      <span className="text-AAsecondary">GraphQL/RESTful APIs</span>,
      <span className="text-AAsecondary">SpringBoot</span>,
      <span className="text-AAsecondary">GitHub</span>,
      <span className="text-AAsecondary">XAMPP/WampServer</span>,
    ],
  ];
  return (
    <div
          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header text-justify">
              <span className="text-gray-400 ">
                I am Aditya Prakash Pandey, a dedicated{" "}
                <span className="text-AAsecondary">Software Engineer</span> at{" "}
                <span className="text-AAsecondary">
                  OWY Technosys Pvt. Ltd.{" "}
                </span>
                , specializing in web and mobile application development. With
                proficiency in Shopify, React.js, Flutter, and SQL, I am
                passionate about building scalable, user-friendly solutions that
                integrate seamlessly across front-end and back-end systems. My{" "}
                <span className="text-AAsecondary">1</span> year of experience
                includes designing high-performance applications, collaborating
                with cross-functional teams, and continuously learning new
                technologies to drive innovation. I hold a{" "}
                <span className="text-AAsecondary">B.Tech</span> in Computer
                Science and Engineering from AKTU University.
              </span>
            </div>
            <div className="font-Header text-justify">
              {/* <span className="text-gray-400 ">
