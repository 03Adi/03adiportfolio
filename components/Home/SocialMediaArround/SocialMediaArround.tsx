      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            {/* Github Icon */}
            <IconClickableWithAnimation Icon={GithubIcon} href={"https://github.com/03Adi"} />
            {/* Linkedin icon */}
            <IconClickableWithAnimation Icon={LinkedinIcon} href={"https://www.linkedin.com/in/aditya033/"} />
            {/* Instagram Icon */}
          ...
          <div className="h-28 w-1.5 bg-gray-400"></div>
        </div>
      </motion.div>
      ...
      >
        <div className="flex flex-col space-y-24 justify-center items-center">
          ...
          <motion.div
            ...
            className=""
          >
            <a href="mailto:adityadeveloper03@gmail.com" target={"_blank"} rel="noreferrer">
              <span className=" font-Header tracking-wider text-gray-400 hover:text-AAsecondary hover:cursor-pointer">
              <span className="text-AAsecondary">adityadeveloper03</span><span className="text-AAsecondary">.com</span>
              </span>
            </a>
          </motion.div>

          <div className="h-24 w-1.5 bg-gray-400"></div>
        </div>
      </motion.div>
    </>
  );
